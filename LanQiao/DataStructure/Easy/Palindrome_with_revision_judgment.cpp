...
#include <iomanip>
#include <cmath>
//https://www.lanqiao.cn/courses/41070/learning/?id=2817434&compatibility=false
using namespace std;
using ll=long long;
...
void solve()
{
  ...
  while (q--)
  {
    ...
    if(op==1)
    {
      cin>>a>>c;
      --a;
      Posstr.update(1,0,n-1,a,c-'a'+1);
      Netstr.update(1,0,n-1,n-1-a,c-'a'+1);
    }
    else
    {
      cin>>a>>b;
      ...
      if((b-a+1)%2==0)
        ++midr;
      if(Posstr.query(1,0,n-1,a,midl)==Netstr.query(1,0,n-1,n-1-b,n-1-(midr)))
        cout<<"Yes\n";
      else
        cout<<"No\n";
    }
